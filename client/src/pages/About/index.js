...
export default function About() {
  return (
    <div id="about" className="fullscreen about p-5">
      ...
      <div className="font-demi font-18 text-primaryColor justify mt-5">
        <Carousel>
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <p className="visibility-none">
                Zealicon is the annual techno-cultural festival of JSSATE,
                Noida. Dedicated to the celebration of creativity and science,
                it is a stimulating event brimming with youthful dynamism. It
                transforms the campus into a veritable kaleidoscope of people.
                Involving multifarious exciting events from technical scratch to
                cultural zeal. A platform for all the creative minds to express
                their ideas in the form of events including band performances,
                discussions, film screenings that are spread over four days.
                Apart from the exuberant cultural events, Zealicon is also known
                for its mind boggling technical events that creates an ambience
                for the technocrats.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <p className="mt-4 visibility-none">
