    ...
    return (
        <div id="home" className="mainShowcase-wrapper">
            <div className="navbarCollege-wrapper">
                <div className="navbar-text navbarCollege">
                    ...
                    <div className="navbarCollege-text">
                        ...
                        <div className="font-18 font-bold">JSS Academy of Technical Education</div>
            ...
            <div className="homeNavbar">
                <Navbar className="navbar-bg navbar-dark custom-navbar" bg="light" expand="lg">
                    <Container>
                        <Navbar.Brand href="/">
        ...
        /> */}
                ...
                <div className="mainShowcase-heading">
                    <span className="mainShowcase-heading-welcome-color font-demi">welcome to</span> <span className="font-bold">Zealicon</span>
                </div>
                <div className="mainShowcase-button-wrapper">
                    <Link to="/zeal" className="text-decoration-none">
                        <div className="mainShowcase-button font-bold text-white">REGISTER NOW</div>
                    </Link>
                </div>
            </div>
        </div>
