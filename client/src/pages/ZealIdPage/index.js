...
export default function ZealIDPage() {
  return (
    <div className="fullscreen login p-100 d-flex flex-column flex-row-lg justify-content-center align-items-center text-white font-48">
      <Link to="/register" className="text-decoration-none">
        <div className="form-bg m-4 text-center">
